<%-- 
    Document   : index
    Created on : 3 Mar, 2019, 2:47:27 AM
    Author     : Rahul
--%>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
  <div class="w3-content">
    ...
    <div id="Pizza" class="w3-container menu w3-padding-32 w3-white">
        <h1><b>Margherita</b> <span class="w3-right w3-tag w3-dark-grey w3-round">$12.50</span></h1> <span>Quantity <input type="text" id="myInput1" placeholder="Title..."></span>
  <span onclick="newElementP1()" class="addBtn">Add</span>
      <p class="w3-text-grey">Fresh tomatoes, fresh mozzarella, fresh basil </p>
      <hr>
   
      <h1><b>Cheese</b> <span class="w3-right w3-tag w3-dark-grey w3-round">$15.50</span> </h1><span>Quantity <input type="text" id="myInput2" placeholder="Title..."></span>
  <span onclick="newElementP2()" class="addBtn">Add</span>
      <p class="w3-text-grey">Four cheeses (mozzarella, parmesan, pecorino, jarlsberg)</p>
      <hr>
      
      <h1><b>Chicken</b> <span class="w3-right w3-tag w3-dark-grey w3-round">$17.00</span></h1> <span>Quantity <input type="text" id="myInput3" placeholder="Title..."></span>
  <span onclick="newElementP3()" class="addBtn">Add</span>
  ...
  <span onclick="newElementD3()" class="addBtn">Add</span>
    ...
    <div>
        ...
        <h1><span class="w3-right w3-tag w3-dark-grey w3-round"></span></h1>
  <span onclick="total()" class="addBtn">Calculate Price</span>
      <hr>
...
function newElementP1() {
  var li = document.createElement("li");
  var li2 = document.createElement("li");
  var inputValue1 = document.getElementById("myInput1").value;
  var i_name = " X Margherita  ";
  //var total=0;
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  var t2 = document.createTextNode(total);
  li.appendChild(t);
  li.appendChild(t2);
  if (inputValue === '') {
...
function newElementP3() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput3").value;
  var i_name = " X Chicken  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
...
function newElementS1() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput4").value;
  var i_name = " X Lasagna  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
...
function newElementS2() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput5").value;
  var i_name = " X Ravioli  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
...
function newElementS3() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput6").value;
  var i_name = " X Spaghetti Classica  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
...
function newElementD1() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput7").value;
  var i_name = " X Today's Soup  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
...
function newElementD2() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput8").value;
  var i_name = " X Bruschetta  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
...
function newElementD3() {
  var li = document.createElement("li");
  var inputValue1 = document.getElementById("myInput9").value;
  var i_name = " X Garlic Bread  ";
  var inputValue = inputValue1.concat(i_name);
  var t = document.createTextNode(inputValue);
  li.appendChild(t);
  if (inputValue === '') {
